<div class="p-8 space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <h1 class="text-2xl font-black text-slate-900 tracking-tight">Natures de projets</h1>
            <p class="text-sm text-slate-400 mt-0.5">Paramètres généraux — types de projets</p>
        </div>
                ...
                <tr class="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2 justify-end">
                            <button wire:click="edit({{ $nature->id }})"
                            ...
                            <button wire:click="confirmDelete({{ $nature->id }})"
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden">
            <div class="px-6 py-5 border-b border-slate-100 flex items-center justify-between">
                <h3 class="text-base font-black text-slate-900">{{ $nature_id ? 'Modifier' : 'Nouvelle' }} nature</h3>
            ...
            <div class="px-6 py-5">
                ...
                <input type="text" wire:model="name" placeholder="Ex : Constructions / Infrastructures"
                    class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400/40 focus:border-orange-400 transition">
    ...
    <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm overflow-hidden">
            ...
            <div class="px-6 pb-6 flex gap-3">
                ...
                <button wire:click="delete" class="flex-1 px-4 py-2.5 rounded-xl text-sm font-bold text-white bg-red-500 hover:bg-red-600">Supprimer</button>
            </div>
        </div>
    </div>
    @endif
